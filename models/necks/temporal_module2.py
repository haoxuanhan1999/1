...
from ..STC import STCrossTransformer
import pdb


@NECKS.register_module()
class Temporal3DConvModelOURS2(BaseModule):
    def __init__(
        self,
        in_channels,
        receptive_field,
        ...
        super(Temporal3DConvModelOURS2, self).__init__(init_cfg)
        ...
        self.STCformer = STCrossTransformer()
